...
const Ajouter = () => {
    ...
    const submitForm = async (event) => {
        ...
        const form = document.getElementById('addCyclistsCategory');
        console.log('form', form);
        const data = new FormData(form) 
        console.log(data);
        const ajouterCyclistsCategory = async () => {
            await axios
                .post('/api/cyclists_category', data, { headers: {"Content-Type":"multipart/form-data"} })
                .then(res => {
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="px-2 py-6 md:px-6 py-6 bg-white border-b border-gray-200">
                            <form onSubmit={submitForm} id="addCyclistsCategory">
                                <div className="mt-4">
                                    <Label htmlFor="name">
                                        Nom de la categorie
                                    </Label>
