            ...
            <div className="bg-slate-100 mb-6">
                <div className="container mx-auto pt-24 md:pt-16 px-6">
                    ...
                    <p>
                        ...
                        capable au sens des articles 1123 et suivants du Code
                        civil, ou personne morale, qui visite le Site objet des
                        présentes conditions générales. <br />
                        <b>Prestations et Services :</b>{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                            https://easy-cyclisme.fr
                        </a>{' '}
                        met à disposition des Clients :
                    </p>
                    <p>
                        <b>Contenu :</b> Ensemble des éléments constituants
                        l’information présente sur le Site, notamment textes –
                        images – vidéos.
                    </p>
                    <p>
                        ...
                        relation client et à des fins d’analyses et de
                        statistiques.
                    </p>
                    <p>
                        <b>Utilisateur :</b> Internaute se connectant, utilisant
                        le site susnommé.
                    </p>
                    <p>
                        <b>Informations personnelles :</b> « Les informations
                        qui permettent, sous quelque forme que ce soit,
                        directement ou non, l'identification des personnes
                        physiques auxquelles elles s'appliquent » (article 4 de
                        la loi n° 78-17 du 6 janvier 1978).
                    </p>
                    <p>
                        Les termes « données à caractère personnel », « personne
                        concernée », « sous traitant » et « données sensibles »
                        ont le sens défini par le Règlement Général sur la
                    ...
                    <p>
                        <strong>Propriétaire</strong> : Nicolas Gicquel – 2
                        Route de notre dame de grâce 44750 Quilly
                        <br />
                        <strong>Responsable publication</strong> : Gicquel
                        Nicolas – nicog.dev@gmail.com
                        <br />
                        Le responsable publication est une personne physique ou
                        une personne morale.
                        <br />
                        <strong>Webmaster</strong> : Gicquel Nicolas –
                        nicog.dev@gmail.com
                        <br />
                        <strong>Hébergeur</strong> : O2switch – 222-224
                        Boulevard Gustave Flaubert 63000 Clermont-Ferrand 04 44
                        44 60 40
                        <br />
                        <strong>Délégué à la protection des données</strong> :
                        Gicquel Nicolas – nicog.dev@gmail.com
                        <br />
                    </p>
                    <div ng-bind-html="linkHTML">
                        <p>
                            Les mentions légales sont issues du modèle proposé
                            par le{' '}
                            <a
                                className="text-blue-900 underline font-semibold"
                                ...
                                générateur gratuit de mentions légales pour un
                                site internet
                            </a>
                        </p>
                    </div>
                    ...
                    <p>
                        ...
                        dispositions du Code de la Propriété Intellectuelle et
                        des Réglementations Internationales applicables. Le
                        Client ne peut en aucune manière réutiliser, céder ou
                        exploiter pour son propre compte tout ou partie des
                    ...
                    <p>
                        Ce site internet est normalement accessible à tout
                        moment aux utilisateurs. Une interruption pour raison de
                        ...
                        utilisateurs les dates et heures de l’intervention. Le
                        site web{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                        ...
                        responsable. De la même façon, les mentions légales
                        peuvent être modifiées à tout moment : elles s’imposent
                        néanmoins à l’utilisateur qui est invité à s’y référer
                    ...
                    <p>
                        ...
                        il ne pourra être tenu responsable des oublis, des
                    ...
                    <p>
                        ...
                        utilisant un matériel récent, ne contenant pas de virus
                        ...
                        l’Union Européenne conformément aux dispositions du
                    ...
                    <p>
                        ...
                        continuité de son service 24 Heures sur 24, tous les
                        jours de l’année. Il se réserve néanmoins la possibilité
                        d’interrompre le service d’hébergement pour les durées
                        les plus courtes possibles notamment à des fins de
                        maintenance, d’amélioration de ses infrastructures, de
                        défaillance de ses infrastructures ou si les Prestations
                    ...
                    <p>
                        ...
                        et l’hébergeur ne pourront être tenus responsables en
                        cas de dysfonctionnement du réseau Internet, des lignes
                        téléphoniques ou du matériel informatique et de
                    ...
                    <p>
                        ...
                        adaptation de tout ou partie des éléments du site, quel
                    ...
                    <p>
                        ...
                        est responsable de la qualité et de la véracité du
                    ...
                    <p>
                        ...
                        répondant pas aux spécifications indiquées au point 4,
                    ...
                    <p>
                        ...
                        indirects (tels par exemple qu’une perte de marché ou
                        ...
                        questions dans l’espace contact) sont à la disposition
                        des utilisateurs.{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                    ...
                    <p>
                        ...
                        confiance dans l’Economie Numérique, la Loi Informatique
                        et Liberté du 06 Août 2004 ainsi que du Règlement
                        Général sur la Protection des Données (RGPD : n°
                        2016-679).{' '}
                    </p>
                    <h3 className="text-xl text-blue-900 font-semibold mt-4 mb-2">
                        7.1 Responsables de la collecte des données personnelles
                    </h3>
                    <p>
                        Pour les Données Personnelles collectées dans le cadre
                        de la création du compte personnel de l’Utilisateur et
                        de sa navigation sur le Site, le responsable du
                        traitement des Données Personnelles est : Nicolas
                        Gicquel.{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                        ...
                        est représenté par Gicquel Nicolas, son représentant
                        légal
                    </p>
                    <p>
                        ...
                        s’engage à respecter le cadre des dispositions légales
                        en vigueur. Il lui appartient notamment au Client
                        d’établir les finalités de ses traitements de données,
                        de fournir à ses prospects et clients, à partir de la
                        collecte de leurs consentements, une information
                        complète sur le traitement de leurs données personnelles
                        et de maintenir un registre des traitements conforme à
                        ...
                        l’exactitude et de la pertinence des Données
                    ...
                    <ul>
                        <li>
                            pour permettre la navigation sur le Site et la
                            gestion et la traçabilité des prestations et
                            services commandés par l’utilisateur : données de
                            connexion et d’utilisation du Site, facturation,
                            historique des commandes, etc.{' '}
                        </li>

                        <li>
                            pour prévenir et lutter contre la fraude
                            informatique (spamming, hacking…) : matériel
                            informatique utilisé pour la navigation, l’adresse
                            IP, le mot de passe (hashé){' '}
                        </li>

                        <li>
                            pour améliorer la navigation sur le Site : données
                        ...
                        <li>
                            ...
                            mail) : numéro de téléphone, adresse email
                        </li>
                    </ul>
                    <p>
                        <a
                        ...
                        ne commercialise pas vos données personnelles qui sont
                        donc uniquement utilisées par nécessité ou à des fins
                    ...
                    <ul>
                        <li>
                            ...
                            d’effacement des données des Utilisateurs à
                            caractère personnel (article 17 du RGPD),
                            lorsqu’elles sont inexactes, incomplètes,
                        ...
                        <li>
                            droit à la portabilité des données que les
                            Utilisateurs auront fournies, lorsque ces données
                            font l’objet de traitements automatisés fondés sur
                            leur consentement ou sur un contrat (article 20
                            RGPD){' '}
                        </li>

                        <li>
                            droit de définir le sort des données des
                    ...
                    <p>
                        ...
                        conservation s’avère nécessaire à des fins probatoires
                    ...
                    <p>
                        ...
                        utilise ses Données Personnelles, demander à les
                        rectifier ou s’oppose à leur traitement, l’Utilisateur
                        peut contacter{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                    ...
                    Nicolas Gicquel – DPO, Gicquel Nicolas <br />2 Route de
                    notre dame de grâce 44750 Quilly.
                    <p>
                    ...
                    <p>
                        Les demandes de suppression de Données Personnelles
                        seront soumises aux obligations qui sont imposées à{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                            https://easy-cyclisme.fr
                    ...
                    <p>
                        ...
                        Informations collectées sur ses Clients vers un pays
                        situé en dehors de l’Union européenne ou reconnu comme «
                        non adéquat » par la Commission européenne sans en
                        ...
                        commerciaux à la condition qu’il présentent les
                        garanties suffisantes au regard des exigences du
                        Règlement Général sur la Protection des Données (RGPD :
                        n° 2016-679).
                    </p>
                    <p>
                        ...
                        s’engage à prendre toutes les précautions nécessaires
                        afin de préserver la sécurité des Informations et
                        notamment qu’elles ne soient pas communiquées à des
                        personnes non autorisées. Cependant, si un incident
                        impactant l’intégrité ou la confidentialité des
                        ...
                        Client et lui communiquer les mesures de corrections
                        prises. Par ailleurs{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                    ...
                    <p>
                        ...
                        exclusivement afin de réaliser les finalités de la
                        présente politique.
                    </p>
                    <p>
                        Dans la limite de leurs attributions respectives et pour
                        les finalités rappelées ci-dessus, les principales
                        personnes susceptibles d’avoir accès aux données des
                        Utilisateurs de{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                    ...
                    <p>
                        ...
                        avertirions les utilisateurs concernés afin qu'ils
                        puissent prendre les mesures appropriées. Nos procédures
                        de notification d’incident tiennent compte de nos
                        obligations légales, qu'elles se situent au niveau
                        national ou européen. Nous nous engageons à informer
                        pleinement nos clients de toutes les questions relevant
                        de la sécurité de leur compte et à leur fournir toutes
                        les informations nécessaires pour les aider à respecter
                        leurs propres obligations réglementaires en matière de
                        reporting.
                    </p>
                    <p>
                        ...
                        informations à l'éventuel acquéreur qui serait à son
                    ...
                    <p>
                        Pour assurer la sécurité et la confidentialité des
                        Données Personnelles et des Données Personnelles de
                        Santé,{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                        ...
                        utilise des réseaux protégés par des dispositifs
                        standards tels que par pare-feu, la pseudonymisation,
                    ...
                    <p>
                        ...
                        prend toutes les mesures raisonnables visant à les
                        protéger contre toute perte, utilisation détournée,
                        accès non autorisé, divulgation, altération ou
                        destruction.
                    </p>
                    <h2 className="text-2xl text-blue-900 font-bold mt-6 mb-4">
                    ...
                    <p>
                        Un « cookie » est un petit fichier d’information envoyé
                        sur le navigateur de l’Utilisateur et enregistré au sein
                        du terminal de l’Utilisateur (ex : ordinateur,
                        smartphone), (ci-après « Cookies »). Ce fichier comprend
                        des informations telles que le nom de domaine de
                        l’Utilisateur, le fournisseur d’accès Internet de
                        l’Utilisateur, le système d’exploitation de
                        l’Utilisateur, ainsi que la date et l’heure d’accès. Les
                        Cookies ne risquent en aucun cas d’endommager le
                    ...
                    <p>
                        ...
                        l’Utilisateur concernant sa visite du Site, telles que
                    ...
                    <p>
                        Les Cookies facilitant la navigation et/ou la fourniture
                        des services proposés par le Site, l’Utilisateur peut
                        configurer son navigateur pour qu’il lui permette de
                        décider s’il souhaite ou non les accepter de manière à
                        ce que des Cookies soient enregistrés dans le terminal
                        ou, au contraire, qu’ils soient rejetés, soit
                        ...
                        des Cookies lui soient proposés ponctuellement, avant
                        qu’un Cookie soit susceptible d’être enregistré dans son
                        terminal.{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                        ...
                        informe l’Utilisateur que, dans ce cas, il se peut que
                        les fonctionnalités de son logiciel de navigation ne
                        soient pas toutes disponibles.
                    </p>
                    <p>
                        Si l’Utilisateur refuse l’enregistrement de Cookies dans
                        son terminal ou son navigateur, ou si l’Utilisateur
                        supprime ceux qui y sont enregistrés, l’Utilisateur est
                        informé que sa navigation et son expérience sur le Site
                        peuvent être limitées. Cela pourrait également être le
                        cas lorsque{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                        ...
                        ou l’un de ses prestataires ne peut pas reconnaître, à
                        des fins de compatibilité technique, le type de
                        navigateur utilisé par le terminal, les paramètres de
                        langue et d’affichage ou le pays depuis lequel le
                    ...
                    <p>
                        ...
                        décline toute responsabilité pour les conséquences liées
                        au fonctionnement dégradé du Site et des services
                        ...
                        , résultant (i) du refus de Cookies par l’Utilisateur
                        (ii) de l’impossibilité pour{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                            https://easy-cyclisme.fr
                        </a>{' '}
                        d’enregistrer ou de consulter les Cookies nécessaires à
                        leur fonctionnement du fait du choix de l’Utilisateur.
                        Pour la gestion des Cookies et des choix de
                        l’Utilisateur, la configuration de chaque navigateur est
                    ...
                    <p>
                        À tout moment, l’Utilisateur peut faire le choix
                    ...
                    <p>
                        ...
                        sociaux Twitter, Facebook, Linkedin et Google Plus
                        ...
                        ou dans son application mobile et si l’Utilisateur a
                        accepté le dépôt de cookies en poursuivant sa navigation
                    ...
                    <p>
                        ...
                        qu’à condition que vous y consentiez, en continuant
                        votre navigation sur le Site Internet ou l’application
                        mobile de{' '}
                        <a
                            className="text-blue-900 underline font-semibold"
                            href="https://easy-cyclisme.fr">
                        ...
                        . À tout moment, l’Utilisateur peut néanmoins revenir
                    ...
                    <p>
                        ...
                        (également appelées « tags », ou balises d’action, GIF à
                        un pixel, GIF transparents, GIF invisibles et GIF un à
                        un) et les déployer par l’intermédiaire d’un partenaire
                        spécialiste d’analyses Web susceptible de se trouver (et
                        donc de stocker les informations correspondantes, y
                        compris l’adresse IP de l’Utilisateur) dans un pays
                        étranger.
                    </p>
                    <p>
                        Ces balises sont placées à la fois dans les publicités
                        en ligne permettant aux internautes d’accéder au Site,
                        et sur les différentes pages de celui-ci.
                    </p>
                    <p>
                        ...
                        l’efficacité de ses actions (par exemple, le nombre de
                        fois où une page est ouverte et les informations
                        consultées), ainsi que l’utilisation de ce Site par
                        l’Utilisateur.{' '}
                    </p>
                    <p>
                        Le prestataire externe pourra éventuellement recueillir
                        des informations sur les visiteurs du Site et d’autres
                        sites Internet grâce à ces balises, constituer des
                    ...
                    <p>
                        ...
                        de juridiction aux tribunaux compétents de Nantes
                    </p>
                </div>
            </div>
